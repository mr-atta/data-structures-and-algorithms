...
------------------------------------------------------------------------------------------------
      ['Ginger', 'Goose', 'Tangerine', 'Rosie', 'Mario', 'Malaki'] >> 2
      [] >> -1
      ['Ginger'] >> 0
 */
...
const longestString = (arr) => {
  ...
  let data = arr.map((ele, i) => {
    if (ele.length > lengthStr) {
      lengthStr = ele.length;
      key = i;
    }
  });
  return key;
...
------------------------------------------------------------------------------------------------
nums = ["(123) 456-7890", "(222) 222-2222"];
>>>>>>>> [
      "1234567890",
      "2222222222",
    ]
...
const standardizePhoneNumbers = (arr) => {
  ...
  let newData = arr.filter((ele) => {
    // filter one  ( ) -
    const regex = /\(|\)|\-|/g;
    let phone = ele.replace(regex, "");
    // filter two space
    let delSpace = phone.replace(" ", "");
    console.log(delSpace);
    newNumbers.push(delSpace);
  });
  return newNumbers;
};
