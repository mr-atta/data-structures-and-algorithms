...
Use the characters data below for all of the challenges 
except challenge 2 and 3.
...
Write a function named containsWorld that takes in a string or number of any length. This function should use a regular expression pattern to 
